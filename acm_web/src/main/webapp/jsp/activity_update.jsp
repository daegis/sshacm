    ...
    <div class="layui-form-item" style="display: none">
        ...
        <div class="layui-input-block">
            <input type="text" name="aid" autocomplete="off"
                   class="layui-input" value="<s:property value="activity.aid"/>">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="activityName" lay-verify="required" placeholder="请输入活动名称" autocomplete="off"
                   class="layui-input" value="<s:property value="activity.activityName"/>">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="activityDate" autocomplete="off" id="date" placeholder="请选择活动的日期"
                   readonly="" class="layui-input" value="<s:property value="activity.activityTime"/>">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="dayCount" lay-verify="number" placeholder="请输入活动天数" autocomplete="off"
                   class="layui-input" value="<s:property value="activity.dayCount"/>">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="activityPrice" lay-verify="number" placeholder="请输入活动价格" autocomplete="off"
                   class="layui-input" value="<s:property value="activity.activityPrice"/>">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="activityBus" placeholder="请输入使用车辆" autocomplete="off"
                   class="layui-input" value="<s:property value="activity.activityBus"/>">
        </div>
    </div>
